...
namespace Recipes.Controllers
{
    public class RecipesController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var recipe = await _context.Recipes.Include(r => r.RecipeSteps).SingleOrDefaultAsync(r => r.Id == id);
            if (recipe == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Category,CreatedDate,Complexity,PreparationTime,ImageUrl, RecipeSteps")] RecipeViewModel recipe)
        {
            var recipeEntity = await _context.Recipes.Include(r => r.RecipeSteps).SingleOrDefaultAsync(r => r.Id == id);
     ...
     public IActionResult AddNewRecipeStep()
{

    return PartialView("RecipeStep", new RecipeStep());
}
    }
}
